...
namespace Tests
{
    public class CurrentControlBlocksTest
    {
        ...
        {
            var controlBlocks = new CurrentControlBlocks(5, 10, MockBlocks);
        ...
        {
            var controlBlocks = new CurrentControlBlocks(4, 14, MockBlocks);
        ...
        {
            var controlBlocks = new CurrentControlBlocks(20, 14, MockBlocks);
        ...
        public void SpinTest()
        {
            ...
            var controlBlocks = new CurrentControlBlocks(5, 15, mockBlocks.Object);
